...
pygame.time.set_timer(obstacle_timer, randint(900,1500))
    ...
    for event in pygame.event.get():
        ...
        if game_active:
            ...
            if event.type == obstacle_timer:
                if randint(0,2):
                    obstacle_rect_list.append(snail_surf.get_rect(bottomright = (randint(900,1200), 300)))
                else:
